    ...
    <div className="slide !p-0 overflow-hidden">
      ...
      <AnimatePresence>
        {step === 1 && (
          ...
          >
            <div className="font-display text-[2rem] sm:text-[4rem] text-white/90 font-medium tracking-wide drop-shadow-2xl text-center">
        ...
        {step >= 2 && (
          <motion.div
            className="absolute inset-0 top-[18vh] pb-6 md:pb-16 px-4 sm:px-8 md:px-16 flex flex-col sm:flex-row gap-4 sm:gap-8 md:gap-12 overflow-y-auto"
