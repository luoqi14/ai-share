...
export default function SlideVectorSpace() {
  ...
  // Detect small screen for responsive motion values
  ...
  return (
    <div className="slide !p-0 overflow-hidden relative flex flex-col items-center justify-center">
      ...
      <AnimatePresence>
        {!show3D && showBox && (
          <motion.div
            className="absolute top-[45%] left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-4 sm:gap-12 z-30 w-full px-4 sm:px-0"
          ...
          >
            ...
            <motion.div
              className="text-sm sm:text-lg md:text-2xl text-[var(--color-primary-fixed-dim)] font-body tracking-wider text-center max-w-3xl"
