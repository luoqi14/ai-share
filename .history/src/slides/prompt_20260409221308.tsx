  ...
  return (
    <div className="slide !p-0 overflow-hidden">
      ...
      <AnimatePresence>
        {showBox && (
          <motion.div
            className="absolute inset-0 top-[15vh] px-16 pb-16 flex items-start justify-center gap-16"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          >
            ...
            <div className="flex-1 max-w-[600px] flex flex-col gap-8 h-full pt-8">
              {/* Concept Intro */}
              <motion.div
