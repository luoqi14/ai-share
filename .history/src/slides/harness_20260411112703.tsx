      ...
      <AnimatePresence>
        ...
        {step === 1 && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
          >
            <div className="font-display flex flex-wrap justify-center text-[4rem] tracking-wider text-white/90 font-medium text-center drop-shadow-2xl">
              {text1.map((char, i) => {
        ...
        {step === 2 && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
          >
            <div className="font-display flex flex-wrap justify-center max-w-4xl text-[3.8rem] tracking-wider text-secondary font-bold text-center drop-shadow-[0_0_15px_rgba(var(--color-secondary),0.4)]">
              {text2.map((char, i) => {
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-6 text-white/70 text-[15px] leading-relaxed">
                      ...
                      <div className="px-5 py-4 border-l-2 border-error/40 bg-error/10 rounded-r-xl">
                        <strong className="text-error font-medium drop-shadow-md">门诊隐喻：</strong>这就像招了一个智商 180 但极其自负、完全不听指挥的散漫医学天才。你让他去“大厅接待”，他为了炫技越过所有护士，直接把患者拉进手术室...
                      </div>
                    </div>
                  </motion.div>
                )}
            ...
            <div className="flex-[0.6] relative flex flex-col bg-surface-container-high/40 rounded-3xl border ghost-border glass-overlay overflow-hidden shadow-2xl">
              <AnimatePresence mode="wait">
                ...
                {step >= 4 && step <= 5 && (
                  <motion.div
                    key="visual-2"
                    className="absolute inset-0 flex flex-col justify-center items-center p-12 bg-black/20"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                  >
                    ...
                    <div className="flex flex-col gap-6 w-full max-w-sm mt-4">
                      <div className="w-full flex items-center bg-[#151515] p-4 rounded-xl border border-white/10 shadow-lg">
                        ...
                        <div className="ml-4 flex flex-col">
                          <div className="text-[14px] text-white/90 font-medium tracking-wide">患者进门强录入</div>
                          <div className="text-[12px] text-white/40 font-mono mt-0.5">传统代码</div>
                        </div>
                      </div>
                      ...
                      <div className="w-full flex items-center bg-[#151515] p-4 rounded-xl border border-white/10 shadow-lg">
                        ...
                        <div className="ml-4 flex flex-col">
                          <div className="text-[14px] text-white/90 font-medium tracking-wide">调阅历史门诊库</div>
                          <div className="text-[12px] text-white/40 font-mono mt-0.5">数据库查询</div>
                        </div>
                      </div>
                      <div className="h-6 w-px bg-gradient-to-b from-white/20 to-transparent mx-auto"></div>
                      <motion.div
                      ...
                      >
                        ...
                        <div className="ml-4 flex flex-col z-10">
                          <div className={`text-[15px] font-medium tracking-wide ${step === 5 ? 'text-secondary font-bold' : 'text-white/90'}`}>生成关怀复诊问候语</div>
                      ...
                      <div className="w-full flex items-center bg-[#151515] p-4 rounded-xl border border-white/10 shadow-lg">
                        <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-xl shrink-0">📨</div>
                        <div className="ml-4 flex flex-col">
                          <div className="text-[14px] text-white/90 font-medium tracking-wide">调用企微 API 投递</div>
                ...
                {step === 7 && (
                  <motion.div
                    key="visual-3"
                    className="absolute inset-0 flex items-center justify-center p-12 bg-black/20"
                    initial={{ opacity: 0, x: 50 }}
                    animate={{ opacity: 1, x: 0 }}
                    exit={{ opacity: 0 }}
                  >
                    <div className="w-[85%] bg-gradient-to-br from-[#121A2F] to-[#0A0F15] border border-blue-400/30 p-8 rounded-3xl shadow-[0_0_60px_rgba(96,165,250,0.15)] relative overflow-hidden group">
                      ...
                      <div className="mt-8 flex flex-col gap-4 relative z-10">
                        <h3 className="text-[28px] font-display text-white font-bold drop-shadow-md">Hermes Agent</h3>
                ...
                {step === 8 && (
                  <motion.div
                    key="visual-4"
                    className="absolute inset-0 flex flex-col justify-center items-center py-10 px-8"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                  >
                    <div className="flex flex-col gap-4 w-full">
                      ...
                      {/* Subagent B */}
                      <div className="bg-[#111] p-5 rounded-2xl border-l-[3px] border-l-secondary border-t border-r border-b border-white/5 shadow-xl flex items-start gap-4 transform translate-x-4">
                      ...
                      {/* Subagent C */}
                      <div className="bg-[#111] p-5 rounded-2xl border-l-[3px] border-l-blue-400 border-t border-r border-b border-white/5 shadow-xl flex items-start gap-4 transform translate-x-8">
                ...
                {step === 9 && (
                  ...
                  >
                    <div className="flex flex-col items-center gap-6 w-full">
                      ...
                      {/* Forking outputs */}
                      <div className="flex w-full justify-between mt-2 pt-4 relative px-8">
                        {/* Red Flow */}
                ...
                {step === 10 && (
                  <motion.div
                    key="visual-6"
                    className="absolute inset-0 flex items-center justify-between p-12 bg-black/30"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                  >
                    {/* Messy unstructured area */}
                    <div className="flex flex-col gap-3 relative w-1/3 h-[70%] justify-center border-r border-dashed border-white/20 pr-6">
                    ...
                    {/* Vacuum GC */}
                    <div className="flex flex-col items-center justify-center relative w-1/3 text-primary group">
                    ...
                    {/* Clean DB */}
                    <div className="flex flex-col gap-3 w-1/3 bg-[#080808] border border-secondary/40 p-6 rounded-2xl shadow-[0_0_40px_rgba(var(--color-secondary),0.15)] h-[60%] ml-4">
            ...
            >
              ...
              <div className="relative z-10 max-w-4xl text-center flex flex-col items-center gap-10">
                ...
                <div className="text-[17px] text-white/80 leading-[2.2] text-justify tracking-wide font-medium bg-black/20 p-10 rounded-3xl border border-white/10 shadow-2xl relative">
                  <div className="absolute -top-4 -left-4 text-6xl text-primary/20 pointer-events-none font-display">"</div>
                  <div className="absolute -bottom-10 -right-4 text-6xl text-primary/20 pointer-events-none font-display">"</div>
